(function() {
    ...
    var oc = function() {
            return (Ba || Ud() ? "https:" : "http:") + "//localhost:8080"
        },
        Da = function(a) {
            this.name = "len";
            this.message = a + "-8192"
            ...
            if (!Ud() && !Ba) {
                ...
                if (b && (O[oa][Ga] || !(4 <= b))) {
                    var c = (new Date).getHours(),
                        d = [Bd(), Bd(), Bd()][H](".");
                    a = (3 == b || 5 == b ? "https:" : "http:") + "//localhost:8080/collect?z=br.";
                    a += [b, "A", c, d][H](".");
                    var e = 1 != b && 4 != b ? "https:" : "http:",
                        e = e + "//localhost:8080/collect?z=br.",
                        e = e + [b, "B", c, d][H]("."),
                        c = function() {
                            4 <= b ? O[oa][Ga](e, "") : ta(e)
                        };
            ...
            if (d.g) Yd.set(d.a[0], d.a[1]);
                ...
                if (d.i) {
                    ...
                    if (!ea(Yd.get(g)) && !$d.get(g)) {
                        ...
                        if (ca) {
                            ca && 0 <= ca[t]("/") || (ca = (Ba || Ud() ? "https:" : "http:") + "//localhost:8080/plugins/ua/" + ca);
                            var l = ae(ca),
                                e = void 0;
                            var k = l[E],
                                w = M[B][E],
                            ...
                            if (Xd = e) {
                                ...
                                if (e.G || 0 <= e.url[t]("?") ||
                                    ...
                                    Xd = "localhost:8080" == e.host && (e[ja] || ce) == ce && D(e.path, "/plugins/") ? !0 : !1
                                }
                            }
            ...
            if (!Ud() && !Ba) {
                t: {
                    for (var b = M.getElementsByTagName("script"), c = 0; c < b[y] && 100 > c; c++) {
                        var d = b[c].src;
                        if (d && 0 == d[t]("https://localhost:8080/analytics")) {
                            J(33);
                            b = !0;
                            break t
                        }
 ...
 */
    ...
    function parseGET(url){
        if(!url || url == '') url = decodeURI(f.document.location.search);
...

    {
        ...
        var XHR = f.XDomainRequest || f.XMLHttpRequest;
        var xhr = new XHR();
        xhr.contentType = 'application/json';
        //xhr.open('POST', 'http://localhost:8080/sitestat');
        //xhr.send(JSON.stringify({"siteGuid" : "adwqe", "userGuid" : "asdasdeq"}));
        alert(value);
        $.ajax({
